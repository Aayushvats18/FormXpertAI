...
import { Plus, Eye, FileText, Calendar, Sparkles, Share2 } from 'lucide-react';
                  ...
                  <div key={form.id} className="bg-gray-50 rounded-xl p-6 hover:bg-gray-100 transition-all duration-200 border border-gray-200 hover:border-gray-300 hover:shadow-md">
                    ...
                    <div className="flex space-x-3">
                      ...
                      <button
                        ...
                        className="flex-1 inline-flex items-center justify-center space-x-2 px-2 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg text-sm font-medium hover:from-green-600 hover:to-emerald-700 transform hover:-translate-y-0.5 transition-all duration-200"
                      >
                        <Share2 className="w-4 h-4" />
                        <span>{copiedFormId === form.id ? 'Copied!' : 'Share'}</span>
                      </button>
                    </div>
                  </div>
                ))}
